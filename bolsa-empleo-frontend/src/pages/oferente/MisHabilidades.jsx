    ...
    return (
        <div>
            <div style={{
                ...
                {/* Boton expandir solo si tiene hijos */}
                {tieneHijos ? (
                    <button
                        type="button"
                        onClick={() => setExpandido(e => !e)}
                        style={{
                            ...
                            lineHeight: 1, flexShrink: 0, width: 12,
                        }}
                    >
                        {expandido ? "▼" : "▶"}
                    </button>
                ...
                <input
                    ...
                    style={{
                        ...
                        flexShrink: 0, accentColor: "var(--color-border-info)",
                    }}
                />
